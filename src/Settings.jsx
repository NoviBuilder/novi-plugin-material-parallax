...
export default class ImageSettings extends Component {
    constructor(props) {
        ...
        this.messages = Language.getDataByKey("novi-plugin-material-parallax");
    }
    ...
    render() {
        return (
            <div>
                <span style={{letterSpacing: "0,0462em"}}>Material Parallax Plugin</span>
    ...
    saveSettings(){
        novi.plugins.settings.update("novi-plugin-material-parallax", this.state.settings);
    }
}